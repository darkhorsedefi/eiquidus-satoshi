...
// explorer view
exports.ex_title = "Satoshi Coin Block Explorer",
exports.ex_description = "A listing of all verified Satoshi Coin transactions",
...
// transaction view
exports.tx_title = "Satoshi Coin Transaction Details",
exports.tx_description = "Viewing tx data from Satoshi Coin block # {2}",
...
// block view
exports.block_title = "Satoshi Coin Block Details",
exports.block_description = "Viewing block data from Satoshi Coin block # {2}",
...
// error view
exports.error_title = "Satoshi Coin Block Explorer Error",
...
// address view
exports.a_title = "Satoshi Coin Wallet Address Details",
exports.a_description = "Viewing balance and transaction data from Satoshi Coin address {2}",
...
// masternode view
exports.mn_title = "Satoshi Coin Masternodes",
exports.mn_description = "A listing of all masternodes known to be active on the Satoshi Coin network",
exports.mn_masternode_list = "Masternode List",

// movement view
exports.move_title = "Satoshi Coin Coin Movements",
exports.move_description = "A listing of larger movements where Satoshi Coin or more {2} coins were sent in a single transaction",

// richlist view
exports.rl_title = "Top Satoshi Coin Coin Holders",
exports.rl_description = "A listing of the richest Satoshi Coin wallet addresses and breakdown of the current coin distribution",
...
// network view
exports.net_title = "Satoshi Coin Network Peers",
exports.net_description = "A listing of Satoshi Coin network peers that have connected to the explorer node in the last 24 hours",
...
// api view
exports.api_title = "Satoshi Coin Public API",
exports.api_description = "A listing of public API endpoints for retrieving Satoshi Coin coin data from the network without the need for a local wallet",
...
// markets view
exports.mkt_title = "Satoshi Coin Market Details",
exports.mkt_description = "Viewing Satoshi Coin market data for the {2} exchange",
...
// claim address view
exports.claim_title = "Satoshi Coin Wallet Address Claim",
exports.claim_description = "Verify ownership of your Satoshi Coin wallet address and set a custom display name in the explorer",

// orphans view
exports.orphan_title = "Satoshi Coin Orphaned Blocks",
...
exports.heavy_title = "Satoshi Coin Reward/Voting Details",
exports.heavy_description = "Viewing Satoshi Coin voting data and coin reward change details",
